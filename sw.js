const CACHE='jlg-project-lab-360-v6-20260909-1';
const CORE=['./','./index.html','./manifest.webmanifest','./project-lab-360-v6-192.png','./project-lab-360-v6-512.png','./v4-1.js','./v4-2.js','./v4-3.js','./v4-4.js','./v4-5.js','./v5-1.js','./v5-2.js','./v5-2-core.js','./v6.js','./v6.css'];
