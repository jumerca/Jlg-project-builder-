/* JLG Project Lab 360 — V10.8 shell stabilization */
(()=>{
  ...
  function branding(){
    document.title='JLG Project Lab 360 — V10.8';
    ...
    const v=$('.version-pill');if(v)v.textContent='V10.8';
    const small=$('.brand small');if(small)small.textContent=nativeAndroid?'V10.8 Android':'V10.8 Autonome';
    const eye=$('.logo-stage .eyebrow');if(eye&&eye.textContent!=='JLG PROJECT LAB 360 · V10.8')eye.textContent='JLG PROJECT LAB 360 · V10.8';
