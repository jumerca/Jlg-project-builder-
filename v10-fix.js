/* JLG Project Lab 360 — V10.6 shell stabilization */
(()=>{
  ...
  function branding(){
    document.title='JLG Project Lab 360 — V10.6 Autonome';
    document.documentElement.dataset.projectLabVersion=VERSION;
    const v=$('.version-pill');if(v)v.textContent='V10.6';
    const small=$('.brand small');if(small)small.textContent='V10.6 Autonome · sans compte, sans backend';
    const eye=$('.logo-stage .eyebrow');if(eye&&eye.textContent!=='JLG PROJECT LAB 360 · V10.6')eye.textContent='JLG PROJECT LAB 360 · V10.6';
